...
public class MediaAnalyst implements VideoAnalyst, AudioAnalyst {
	...
	public static void main(String[] args) {
		ResultProcesser processer = new ResultProcesser() {
			...
			@Override
			public void sendServerConnectTime(long sct) {
				// TODO Auto-generated method stub
				
			}
		};

		String audioPageLink = "http://music.baidu.com/song/247911654";
		String videoPageLink = "http://www.tudou.com/albumplay/l5N_9_O9NVE.html";
		// "http://video.sina.com.cn/vlist/news/zt/topvideos4/#119780349";
...
//		videoAnalyst.startVideoAnalyst(Platform.Tudou, "mp4", processer, 1000000);
		 audioAnalyst.startAudioAnalyst("128", processer, 10000);
	}
}
